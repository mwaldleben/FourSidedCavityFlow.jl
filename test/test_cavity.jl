@testset "cavity.jl" begin
    ...
    @testset "f!" begin
        ...
        fu_ref = [-0.0624820681282460, 0.576027334953858, 0.245807608047586, -0.642691167651798, 0.0121206968541711, -0.642691167651798, 0.245807608047580, 0.576027334953857, -0.0624820681282459]
        @test fu ≈ fu_ref
    end
    @testset "ftime!" begin
        ...
        fu_ref = [-0.062482068128246, 1.821383847328691, 0.245807608047586, -1.888047680026632, 0.012120696854171, -1.888047680026630, 0.245807608047579, 1.821383847328690, -0.062482068128246]
