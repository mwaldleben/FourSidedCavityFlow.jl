function SpectralMesh1D(nbcells, span, spectralmethod="chebychev")
    nodes, diff1mat, diff2mat, diff4mat  = diffchebychev(nbcells, span)
...
function SpectralMesh2D(nbcells, xspan, yspan, spectralmethod="chebychev")
    xnodes, diffx1mat, diffx2mat, diffx4mat  = diffchebychev(nbcells[1], xspan)
    ynodes, diffy1mat, diffy2mat, diffy4mat  = diffchebychev(nbcells[2], yspan)
