...
function construct_BC!(p)
    ...
    @inbounds @views @. Ψ[3:n-1,2] = m11*(bctop[3:n-1]-h1) + m12*(bcbottom[3:n-1]-h2)
    @inbounds @views @. Ψ[3:n-1,n] = m21*(bctop[3:n-1]-h1) + m22*(bcbottom[3:n-1]-h2)
...
function setup_params(n, Re)
    ...
    p = CavityParameters{Float64}(Re,n,nodes,D1,D2,D4,bcleft,bcright,bctop,bcbottom,Minv[1,1],Minv[1,2],Minv[2,1],Minv[2,2],h1,h2,k1,k2,fΨ,Ψ,Ψ0,D2Ψ,ΨD2,D4Ψ,ΨD4,biharmΨ,laplΨ)
